...
$config['host_dev'] = array('localhost', '127.0.0.1', '::1','192.168.100.3');

// Fill in the file of your project here when you develop locally.
$host_dev = 'M-preventive';

// Fill in the domain name here when your project is online.
// Example : www.johndoe.com  your_domain.tld
//           johndoe.com
$host_prod = 'M-preventive';
...
$config['upload_dir']     = $config['upload_dir'] . '/images';
