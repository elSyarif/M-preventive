...
<div class="content-wrapper">
	<section class="content-header">
		<h1><?php echo lang('edit_mesin_heading');?>
			<small>Mesin</small>
		</h1>	
	  <ol class="breadcrumb">
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="box box-info">
        ...
        <!-- Isi -->
<?php echo form_open_multipart('admin/mesin/edit_action/'.$data_mesin['ID']); ?>
    <div class="box-body">
      <div class="clearfix">
        <div class="form-group">
          ...
          <input type="hidden" name="id" value="<?php echo $data_mesin['ID']; ?>">
          <input type="text" name="No_Mesin" value="<?php echo $data_mesin['No_Mesin']; ?>"class="form-control" id="No_Mesin" />
        ...
        <div class="form-group">
          ...
          <input type="text" name="Nama_Mesin" value="<?php echo $data_mesin['Nama_Mesin']; ?>" class="form-control" id="Nama_Mesin" />
        </div>
        <div class="form-group">
          <label for="area_mesin" class="control-label">
            Area
          </label>
          <input type="text" name="Area" value="<?php echo $data_mesin['Area']; ?>" class="form-control" id="Area" />
        </div>
        <div class="form-group">
